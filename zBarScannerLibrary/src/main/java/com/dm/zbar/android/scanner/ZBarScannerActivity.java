...
// Add preview to previewLayout
       ...
       // Drawable myDrawable = getResources().getDrawable(R.drawable.line);
        Drawable myDrawable = getResources().getDrawable(R.drawable.img3);
        Bitmap overlayBitmap = ((BitmapDrawable) myDrawable).getBitmap();
        if (overlayBitmap != null) {
           ...
           // Bitmap rotatedBitmap = Bitmap.createBitmap(overlayBitmap, 0, 0, overlayBitmap.getWidth(),overlayBitmap.getHeight(), matrix, true);
            ...
            oImageView.setImageBitmap(overlayBitmap);
            oImageView.setAlpha(127);
            Animation slideUp = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.slideup);
            //oImageView.startAnimation(slideUp);
